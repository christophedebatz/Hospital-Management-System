...
public class MaladeFormView extends JDialog implements IFormView {

    private FormType formType;
    private final String className = this.getClass().getSimpleName().replace("FormView", "");
    
    public MaladeFormView(JFrame parent, boolean modal) {
        super(parent, modal);
    ...
    public void setMutuelle(String mutuelle) {
        this.mutuelleField.setText(mutuelle);
    }
    
    public String getMutuelle() {
        return this.mutuelleField.getText();
    }
    ...
    private void initComponents() {
        ...
        mutuelleField = new javax.swing.JTextField();
        ...
        jLabel8.setText("No. téléphone :");

        mutuelleField.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(mutuelleField, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(mutuelleField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
    ...
    private javax.swing.JTextField mutuelleField;
